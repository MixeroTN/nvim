return {
  ...
  config = function()
    require("presence").setup({
      ...
      workspace_text = "Working on git repository", --"Working on %s", -- Format string rendered when in a git repository (either string or function(project_name: string|nil, filename: string): string)
